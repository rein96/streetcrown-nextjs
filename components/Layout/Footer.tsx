...
function Footer() {
  return (
    <>
      <footer className={'flex items-center justify-center text-white border-t'}>
        <div className='flex items-center flex-col sm:flex-row'>
          <div className='footer-logo-container mx-4 py-6'>
            <Image src='/assets/streetcrown-round-logo.svg' width={200} height={200} />
          </div>
          <div className='sub-footer-container px-6 py-6'>
            ...
            <a href="https://goo.gl/maps/x4cAuisnTuMBxjtQ9" target="_blank" rel="noopener noreferrer">
              <div className='icon-container flex items-center py-3'>
                <Image src='/assets/location.svg' alt='location' width={28} height={28} />
